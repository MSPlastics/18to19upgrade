...
QWEB_ARCH = '''<t t-call="web.html_container">
    <t t-foreach="docs" t-as="doc">
        ...
        <t t-set="ship_instr" t-value="doc.partner_shipping_id.x_studio_shipping_instructions or doc.partner_shipping_id.commercial_partner_id.x_studio_shipping_instructions or ''"/>
                ...
                <tr>
                    ...
                    <td style="width:32%; background-color:#f1f5f9; vertical-align:top; padding:20px; border-radius:4px; border-top:6px solid #0A182F; box-sizing:border-box;">
                        ...
                        <table style="width:100%; border-collapse:collapse;">
                            ...
                            <tr t-if="doc.commitment_date"><td style="padding:6px 0; border-bottom:1px solid #cbd5e1; font-size:7.5pt; text-transform:uppercase; color:#334155; font-weight:bold;">Expected Delivery Date</td><td style="padding:6px 0; border-bottom:1px solid #cbd5e1; font-size:10pt; font-weight:bold; text-align:right; color:#0A182F;"><t t-out="doc.commitment_date.strftime('%m/%d/%Y')"/></td></tr>
