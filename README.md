...
- **Vendored on staging only (not yet on prod)**: `msppartialMO` 19.0.1.0.0 — required by the MES central server (`action_increment_qty_producing` / `action_ship_partial_batch` / `action_close_and_backorder`)
